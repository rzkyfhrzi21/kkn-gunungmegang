                            ...
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody class="text-body-md">
                                    <?php foreach ($perangkat as $p): ?>
                                        <tr class="border-b border-border-neutral hover:bg-surface-container transition-colors">
                                            <td class="p-4 font-bold text-on-surface"><?= htmlspecialchars($p['nama']) ?></td>
                                            <td class="p-4 text-slate-text-muted"><?= htmlspecialchars($p['jabatan']) ?></td>
                                            <td class="p-4 text-right"><span class="inline-block bg-primary-fixed text-on-primary-fixed-variant text-xs px-2 py-1 rounded">Aktif</span></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
