...
<style>
  ...
  .site-header {
    ...
    z-index: 1000;
    background: #ffffff;
    box-shadow: 0 2px 14px rgba(6, 35, 27, .10);
  }
  ...
  .btn-contact:hover {
    ...
    box-shadow: 0 6px 16px rgba(10, 61, 47, .25);
  }
  ...
  @media (max-width:1024px) {
    ...
    .site-nav.open {
      display: flex;
      animation: navOpenFade .22s ease;
    }

    @keyframes navOpenFade {
      from {
        opacity: 0;
  ...
  .front-preview-loading {
    ...
    border-radius: 50%;
    animation: frontSpin 1s linear infinite;
  }
