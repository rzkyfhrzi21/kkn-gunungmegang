  ...
  <div class="nav-dropdown" id="navDropdownProfil">
    ...
    <div class="nav-dropdown-menu" role="menu" aria-label="Menu Profil Pekon">
      <a href="profil-desa" class="nav-dropdown-item<?= $activePage === 'profil-desa' ? ' active' : '' ?>" role="menuitem">
        <svg class="nd-icon" viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a8 8 0 100 16A8 8 0 0010 2zm0 3a2 2 0 110 4 2 2 0 010-4zm0 9c-2.5 0-4.71-1.28-6-3.22C4 9.14 7.13 8 10 8c2.87 0 6 1.14 6 2.78C14.71 12.72 12.5 14 10 14z"/></svg>
        Profil Desa
      </a>
      <a href="pemerintahan" class="nav-dropdown-item<?= $activePage === 'pemerintahan' ? ' active' : '' ?>" role="menuitem">
        <svg class="nd-icon" viewBox="0 0 20 20" fill="currentColor"><path d="M10 1L2 6v1h16V6L10 1zM3 8v7h3V8H3zm5 0v7h4V8H8zm6 0v7h3V8h-3zM1 16h18v2H1v-2z"/></svg>
        Pemerintahan
      </a>
      <a href="apbpekon" class="nav-dropdown-item<?= ($activePage === 'apbpekon' || $activePage === 'apbpekon-2026') ? ' active' : '' ?>" role="menuitem">
        <svg class="nd-icon" viewBox="0 0 20 20" fill="currentColor"><path d="M4 4h12a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2zm1 3v2h5V7H5zm0 4v2h5v-2H5zm7-4v6h3V7h-3z"/></svg>
        APB Pekon
      </a>
    </div>
  </div>
