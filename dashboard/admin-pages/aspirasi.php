        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <dl class="row mb-0" id="asp-detail-dl">
                    ...
                    <dd class="col-sm-9" id="asp-d-nama">-</dd>
                    <dt class="col-sm-3">WhatsApp</dt>
                    <dd class="col-sm-9" id="asp-d-telepon">-</dd>
                    <dt class="col-sm-3">Kategori</dt>
                    <dd class="col-sm-9" id="asp-d-subjek">-</dd>
                    <dt class="col-sm-3">Tanggal</dt>
                    <dd class="col-sm-9" id="asp-d-tanggal">-</dd>
                    <dt class="col-sm-3">IP</dt>
                    <dd class="col-sm-9" id="asp-d-ip" class="text-muted small">-</dd>
        ...
        var table = new App.JsonTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    label: 'Tanggal',
                    format: function(row, v) {
                        return '<small class="text-muted">' + App.esc(formatTanggal(v)) + '</small>';
                    }
                }
            ],
            ...
            function wrapActs() {
                tbody.querySelectorAll('td.row-actions').forEach(function(cell) {
                    ...
                    btns.forEach(function(btn, i) {
                        ...
                        if (act === 'detail') {
                            btn.innerHTML = '<i class="bi bi-eye text-info"></i>Lihat Detail';
                        } else if (act === 'delete') {
