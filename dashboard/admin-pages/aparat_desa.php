...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var table = new App.JsonTable({
        ...
        columns: [
            ...
            { key: 'foto', label: 'Foto', format: function (row, v) { return fotoCell(v, row.nama); } },
            { key: 'nama', label: 'Nama' },
    ...
    formAparat.addEventListener('submit', function (e) {
        ...
        App.postJSON('../admin/api.php', {
            ...
            data: { nama: formAparat.nama.value, jabatan: formAparat.jabatan.value, foto: formAparat.foto.value, index: formAparat.index.value }
        }).then(function (res) {
            if (res.ok) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    formK.addEventListener('submit', function (e) {
        e.preventDefault();
        if (!formK.checkValidity()) { formK.reportValidity(); return; }
        btnK.disabled = true;
        App.postJSON('../admin/api.php', {
        ...
        }).catch(function () { btnK.disabled = false; App.toast('Terjadi kesalahan jaringan.', 'error', 'Gagal'); });
    });
});
</script>