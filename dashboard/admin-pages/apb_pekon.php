            ...
            <div class="col-lg-7">
                <div class="card h-100 mb-0">
                    ...
                    <div class="card-body py-2">
                        <div id="apb-chart-kompilasi"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-5">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var hasData = numYears > 0 &&
                chartKompilasi.pendapatan.some(function(v) {
                    return v > 0;
                });
            if (elKompilasi && !hasData) {
                noData(elKompilasi);
            } else if (elKompilasi) {
                new ApexCharts(elKompilasi, {
                    ...
                    series: [{
                            name: 'Pendapatan',
                            data: chartKompilasi.pendapatan
                        },
                        {
                            name: 'Belanja',
                            data: chartKompilasi.belanja
                        },
                        {
                            name: 'Pembiayaan',
                            data: chartKompilasi.pembiayaan
                        }
                    ],
            ...
            if (elSurplus) {
                ...
                var hasSurplus = surplusData.some(function(v) {
                    return v !== 0;
                });
                if (!hasSurplus) {
                    noData(elSurplus);
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            formApb.addEventListener('submit', function(e) {
                ...
                App.postJSON('../admin/api.php', {
                    action: 'save_row',
                    module: formApb.module.value,
                    data: {
                        key: formApb.key.value,
                        nominal: formApb.nominal.value,
                        tahun: TAHUN
                    }
                }).then(function(res) {
                    if (res.ok) {
